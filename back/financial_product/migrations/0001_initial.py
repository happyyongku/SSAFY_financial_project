# Generated by Django 4.2.6 on 2024-05-21 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_user', models.ManyToManyField(blank=True, null=True, related_name='user_installment', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_36_p', models.FloatField(blank=True, null=True)),
                ('fin_co_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financial_product.financialcompany')),
                ('joined_user', models.ManyToManyField(blank=True, null=True, related_name='user_deposit', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='DepositOption',
