<template>
  <div class="d-flex justify-content-center">
    <div class="m-3 w-75">
      <h3 class="noto"> 신혼 여행을 위한 환율 계산기</h3>
      <div class="border border-3 p-3">
        <h3 v-if="store.tradeType==='sell'" class="noto">TTS</h3>
        <h3 v-if="store.tradeType==='buy'" class="noto">TTB</h3>
        <div class="d-flex justify-content-center"> 
          <form @submit.prevent="changeRate" class="mb-3">
        ...
        <div class="inner-border d-flex justify-content-evenly">
          ...
          <img src="@/assets/switch.png" alt="switch button" class="switch-button" @click="switching">
